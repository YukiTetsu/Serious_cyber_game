...
Modules utilisés
Le projet utilise les modules Python suivants :
...
import glob  # Pour la recherche de chemins de fichiers
...
bash
Copier le code
git clone https://github.com/votre-utilisateur/cybersecurity-serious-game.git
...
Utilisation
Ouvrez Cisco Packet Tracer et configurez la room selon les instructions fournies dans le jeu.
...
Contact
Pour toute question ou commentaire, veuillez contacter [votre email].
